...
// marvel_Heros.push(dc_Heros);  // array can contain any value ie. it may be string may be number or may be another array and push method insterts one array in another .
...
// let new_another_array = another_arry.flat(Infinity); // flat will merge all array and instead of infinity we an give the depth vale so that it will merge till where ;
